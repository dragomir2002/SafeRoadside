...
# -----------------------------------------------------------------------------
def find_best_trajectory(current_traj, predefined_trajs, max_points=100, score_threshold=3000):
        ...
        while True:
            ...
            for track in tracks:
                ...
                if obj_class in vehicle_classes:
                    ...
                    best_traj = find_best_trajectory(past_points, predefined_trajectories, max_points=100)
                    # Desenhar
                    for pt in best_traj:
